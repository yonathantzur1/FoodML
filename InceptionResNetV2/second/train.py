...
main_dir = "/home/yonathantzur1/food/"
train_dir = "ex4/second/"
...
def train_model(model_name=None):
    ...
    model_final.compile(loss="categorical_crossentropy",
                        optimizer=optimizers.SGD(lr=0.001, decay=1e-6, momentum=0.8),
                        metrics=["accuracy"])
    ...
    network_file_name = main_dir + train_dir + "model_{}.h5".format(int(time.time()))
...
if __name__ == '__main__':
    train_model(main_dir + "ex4/first/model_1561786299.h5")
